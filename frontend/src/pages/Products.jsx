    ...
    <div className="pt-20">
      ...
      <section className="bg-[#1B4D3E] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 text-center">
          ...
          <p className="text-xl text-[#AFE1AF] max-w-3xl mx-auto">
            Innovative software solutions built for the future of engineering and energy.
          </p>
        </div>
      </section>
          ...
          {products.map((product, index) => (
            ...
            >
              ...
              <div className={index % 2 === 1 ? "md:col-start-2" : ""}>
                ...
                <p className="text-lg font-semibold text-[#4E8F74] mb-4">
                  {product.tagline}
                </p>
                ...
                <div className="mb-8">
                  ...
                  <ul className="space-y-3">
                    {product.features.map((feat, idx) => (
                      <li key={idx} className="flex items-center gap-3">
                        <div className="bg-[#AFE1AF] w-2.5 h-2.5 rounded-full"></div>
                        <span className="text-gray-700">{feat}</span>
                      </li>
                    ))}
                  </ul>
                ...
                <button
                  onClick={() => navigate(product.link)}
                  className="bg-[#1B4D3E] text-white px-8 py-3 rounded-lg font-semibold 
                             hover:bg-[#AFE1AF] hover:text-[#1B4D3E]
              ...
              >
                <div className="relative rounded-2xl overflow-hidden shadow-2xl">
                  <div className="absolute inset-0 bg-[#AFE1AF] opacity-20 blur-3xl"></div>
